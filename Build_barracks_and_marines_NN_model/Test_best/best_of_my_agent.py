...
_THRES_VECTOR = numpy.load("best_Thres_vector.npy").item()
_MATRIX_A_0 = numpy.load('best_Matrix_a_0.npy').item()
_MATRIX_A_1 = numpy.load('best_Matrix_a_1.npy').item()
...
class Build_Marine(base_agent.BaseAgent):
  ...
  def step(self, obs):
    ...
    army_supply = obs.observation["player"][_ARMY_SUPPLY]from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
