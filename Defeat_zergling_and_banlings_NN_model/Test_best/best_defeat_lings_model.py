...
try:
  Threat_matrix_a_0 = numpy.load('best_threat_a_0.npy').item()
  ...
  Best_score = numpy.zeros((_NUM_POPULATION_SIZE,1))
...
os.system("python -m pysc2.bin.agent \
  ...
  --agent pysc2.agents.Test_lings_model.best_of_my_agent.Attack_Zerg")
